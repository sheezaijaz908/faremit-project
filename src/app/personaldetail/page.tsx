...
const countries = [
  { id: 1, name: "United Kingdom", flag: "/Country (1).svg", code: "+44" },
  { id: 2, name: "United States", flag: "/Country (2).svg", code: "+1" },
  { id: 3, name: "Canada", flag: "/Country (3).svg", code: "+1" },
  { id: 4, name: "Australia", flag: "/Country (4).svg", code: "+61" },
  { id: 5, name: "Germany", flag: "/Country (5).svg", code: "+49" },
  { id: 6, name: "France", flag: "/Country (6).svg", code: "+33" },
  { id: 7, name: "Italy", flag: "/Country (7).svg", code: "+39" },
  { id: 8, name: "Spain", flag: "/Country (8).svg", code: "+34" },
  { id: 9, name: "Netherlands", flag: "/Country (9).svg", code: "+31" },
  { id: 10, name: "Ireland", flag: "/Country (10).svg", code: "+353" },
  { id: 11, name: "Sweden", flag: "/Country (11).svg", code: "+46" },
  { id: 12, name: "Norway", flag: "/Country (12).svg", code: "+47" },
];
  ...
  return (
    <main className="w-full bg-white flex items-center justify-center">
      <div className="w-full max-w-6xl flex min-h-[110vh]">
        ...
        {/* RIGHT FORM */}
        <div className="w-full lg:w-[52%] flex flex-col justify-center px-6 sm:px-14 relative">

          {/* Decorative Circles */}
          <div className="absolute top-0 right-0">
            <svg width="200" height="200" viewBox="0 0 200 200" fill="none">
              <circle cx="150" cy="50" r="120" stroke="#E5E7FF" />
              <circle cx="170" cy="30" r="120" stroke="#E5E7FF" />
            </svg>
          </div>
          ...
          <div className="max-w-md mx-auto w-full">
           ...
           {/* Sending From — DROPDOWN */}
            ...
            {/* Finish Button */}
            <button className="w-full bg-[#635BFF] hover:bg-[#544CFF] text-white py-3 rounded-md font-medium transition">
              Finish
            </button>
          </div>
        </div>
