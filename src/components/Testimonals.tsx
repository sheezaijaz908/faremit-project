      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="mt-20 text-left">
          ...
          <div className="flex">
            ...
            {/* Card 1 */}
            <div className="rounded-2xl p-10 bg-[rgba(255,238,232,1)] w-[644px] h-[280px]">
            ...
            {/* Card 2 */}
            <div className="rounded-2xl p-10 bg-[rgba(238,237,252,1)] w-[588px] h-[280px]">
            <p className="text-[#2E2E2E] leading-relaxed">
          ...
          <div className="flex">
            ...
            {/* Card 3 */}
            <div className="rounded-2xl p-10 bg-[rgba(247,246,248,1)]
                            w-[588px] h-[280px]">
              <p className="text-[#2E2E2E] leading-relaxed">
            ...
            {/* Card 4 */}
            <div className="rounded-2xl p-10 bg-[rgba(239,254,244,1)]
                            w-[644px] h-[280px]">
              <p className="text-[#2E2E2E] leading-relaxed">
                I’ve been using Faremit for a few months now, and I couldn’t be
                happier! The app is super easy to use, and I can send money to my
